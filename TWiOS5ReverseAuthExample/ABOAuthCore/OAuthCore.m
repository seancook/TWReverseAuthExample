...
NSString *OAuthorizationHeader(NSURL *url, NSString *method, NSData *body, NSString *_oAuthConsumerKey, NSString *_oAuthConsumerSecret, NSString *_oAuthToken, NSString *_oAuthTokenSecret)
{
    //    SC_LOG(url)
    //    SC_LOG(method);
    //    SC_LOG(_oAuthConsumerKey);
    //    SC_LOG(_oAuthConsumerSecret);
    ...
    //    SC_LOG(normalizedParameterString);
    ...
    //    SC_LOG(signatureBaseString);
    
    // Updated this from original to allow us to pass in null to method
    ...
    //    SC_LOG(authorizationHeaderString);
